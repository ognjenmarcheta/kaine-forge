...
- 29028d4: Add Resend production email adapter selected via EMAIL_PROVIDER=resend.
...
- a53d830: Add provider-agnostic email package with a console (Pino) dev adapter and EMAIL_PROVIDER-based factory
