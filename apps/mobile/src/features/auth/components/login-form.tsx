  ...
  return (
    <ScreenContainer>
      <View className="mt-8 rounded-xl bg-background-surface p-4 shadow-raised">
        <Text className="text-2xl font-semibold text-text-default">{t("auth.login.title")}</Text>
        <Text className="mt-1 text-sm text-text-subtle">{t("auth.login.subtitle")}</Text>
        ...
        <View className="mt-4 flex-row items-center justify-center gap-1">
          <Text className="text-sm text-text-subtle">{t("auth.login.noAccount")}</Text>
